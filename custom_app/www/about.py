...
def get_context(context):
	...
	context.about_history = frappe.db.get_all("Company History", filters={}, fields="*")

	context.about_team = frappe.db.get_all("About Us Team Member", filters={}, fields="*")
	context.about_company =frappe.db.get_all("About Us Settings", filters={}, fields="*")
	# context.contact_us = frappe.db.get_all("Contact Us",filters={}, fields="*")

	# print context.contact_us
	print context.about_company